...
import com.training.studentservice.dto.School;
import com.training.studentservice.dto.StudentResponse;
...
public class StudentService {
    ...
    public ResponseEntity<?> fetchStudentById(String id){
        ...
        if(student.isPresent()){
            School school = restTemplate.getForObject("http://SCHOOL-SERVICE:8082/school/" + student.get().getSchoolId(), School.class);
